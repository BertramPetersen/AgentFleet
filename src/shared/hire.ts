 ...
 * `agentfleet://hire?src=<https-url>` deep link or an in-app file picker.
 *
...
/** Parse a `agentfleet://hire?src=<https-url>` deep link. Returns the https
...
export function parseHireDeepLink(link: string): string | null {
  ...
  if (u.protocol !== 'agentfleet:') return null;
  // Both agentfleet://hire?src= (host) and agentfleet:hire?src= (path).
