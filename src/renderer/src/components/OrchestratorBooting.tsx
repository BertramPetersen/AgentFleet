...
/**
 * Loader shown on the empty fleet while the orchestrator (the god agent) is
 * in on launch. Replaces the "add agent" prompt so a returning user doesn't see
 * the empty-floor call-to-action before the orchestrator has booted.
 */
export function OrchestratorBooting() {
  return (
    <div style={{
        ...
        <PixelPanel variant="dialog" title="CLOCKING IN" noPadding>
          <div style={{
            ...
            <p style={{
              ...
              The orchestrator is booting and getting the fleet
              ready. Hang tight…
            </p>
          </div>
        </PixelPanel>
